      ...
      <div className="max-w-2xl w-full mx-auto">
        ...
        <div className="bg-linear-to-br from-(--bg-card) to-(--gold-dark) border border-(--border-default) rounded-2xl p-6 sm:p-8 shadow-(--shadow-medium)">
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <input
              className="w-full h-13 px-4 bg-(--bg-main) border-2 border-(--border-default) rounded-md text-(--text-primary) placeholder:text-(--text-tertiary) focus:outline-none focus:ring-2 focus:ring-(--gold-glow) transition-(--transition-normal)"
              type="text"
